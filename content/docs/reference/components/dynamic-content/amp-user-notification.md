...
For handling CORS requests and responses, see the [AMP CORS spec](https://github.com/ampproject/amphtml/blob/master/extensions/amp-user-notification/../../spec/amp-cors-requests.md).
{% endcall %}
